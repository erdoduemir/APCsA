			...
			if (toClear.size() == 0){
				...
				if (counts[x][y] == 0) {
					...
					if (x > 0 && buttons[x-1][y].isEnabled()) {//left
						buttons[x-1][y].setText(counts[x+1][y-1] + "");
					...
					if ( x > 0 && y < counts[0].length - 1 && buttons[x-1][y+1].isEnabled()) {//right
						buttons[x+1][y-1].setText(counts[x+1][y-1] + "");
						buttons[x+1][y-1].setEnabled(false);
						if (counts[x+1][y-1] == 0) {
							toClear.add((x+1) * 100 + (y-1));
					...
					if (x < counts.length - 1 && y < counts[0].length - 1 && buttons[x+1][y+1].isEnabled()) {//down left
						buttons[x-1][y+1].setText(counts[x-1][y-1] + "");
						buttons[x-1][y+1].setEnabled(false);
						if (counts[x-1][y+1] == 0) {
							toClear.add((x-1) * 100 + (y+1));
